        ...
        this.draw = function (nv) {
            ...
            switch (opt.skin) {
                ...
                case 'default' :
                    ...
                    if (opt.displayPrevious && !opt.readOnly) {
                        ctx.beginPath();
                        ctx.strokeStyle = (v == nv) ? opt.fgColor : cgcolor;
                        ctx.arc(r, r, r - lw / 2, sa, ea, false);
                        ctx.stroke();
                    }
                    if (opt.readOnlyStart && this.first && sa != ea) {
                        this.first_strokeStyle = cgcolor;
                        this.first_r = r;
                        this.first_lw = lw;
                        this.first_sa = sa;
                        this.first_ea = ea;
                    ...
                    if (opt.readOnlyStart && opt.readOnly && opt.displayPrevious)
                    {
                        ctx.beginPath();
                        ctx.strokeStyle = this.first_strokeStyle;
                        ctx.arc(this.first_r, this.first_r, this.first_r - this.first_lw / 2, this.first_sa, this.first_ea, false);
                        ctx.stroke();
                    }
                ...
                opt = $.extend(
                    {
                        ...
                        , 'readOnlyStart' : $this.data('readonlystart')
